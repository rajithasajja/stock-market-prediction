  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Portfolio drawdown over the backtesting period.</CardDescription>
      </CardHeader>
      <CardContent>
            ...
            <ChartContainer config={chartConfig} className="h-full w-full">
                <AreaChart data={data} margin={{ top: 10, right: 10, left: 10, bottom: 0 }}>
                    ...
                    <Tooltip 
                        ...
                        />} 
                    />
                    <Area type="monotone" dataKey="drawdown" stroke="var(--color-drawdown)" strokeWidth={2} fillOpacity={1} fill="url(#colorDrawdown)" />
                </AreaChart>
            </ChartContainer>
        </div>
      </CardContent>
